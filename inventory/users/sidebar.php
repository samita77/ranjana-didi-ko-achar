...
<div class="sidebar">
    <ul>
        ...
        <li class="dropdown">
            <a href="#" onclick="toggleDropdown(event, 'sales')">
                <div class="menu-item">
            ...
            <ul id="sales" class="submenu">
                <li><a href="view_sales.php">View Sales</a></li>
                <li><a href="add_sales.php">Add Sales</a></li>
            </ul>
        </li>
        <li class="dropdown">
            <a href="#" onclick="toggleDropdown(event, 'purchase')">
                <div class="menu-item">
        ...
        <li class="dropdown">
            <a href="#" onclick="toggleDropdown(event, 'vendor')">
                <div class="menu-item">
